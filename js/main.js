...
function anotherRecipe() {
  var randamIndex = Math.floor(Math.random() * recipes.length);
  console.log(recipes[randamIndex]);
  addImage(recipes[randamIndex].imgCover);
  dispalyIngredients(recipes[randamIndex].ingredients);
  dispalyInstructions(recipes[randamIndex].instructions);
  dispalyNutrition(recipes[randamIndex].nutrition);
  dispalyTips(recipes[randamIndex].tips);
  document.getElementById("ratingsQuantity").innerHTML =
    `${recipes[randamIndex].ratingsQuantity} Reviews`;
  document.getElementById("ratingsAverage").innerHTML =
    `${recipes[randamIndex].ratingsAverage}`;
  document.getElementById("prepTime").innerHTML =
    `${recipes[randamIndex].prepTime}`;
  document.getElementById("cookTime").innerHTML =
    `${recipes[randamIndex].cookTime}`;
  document.getElementById("servings").innerHTML =
    `${recipes[randamIndex].servings}`;
  document.getElementById("difficulty-badge").innerHTML =
    `${recipes[randamIndex].difficulty}`;
  document.getElementById("category-badge").innerHTML =
    `${recipes[randamIndex].category}`;
  document.getElementById("name").innerHTML = `${recipes[randamIndex].name}`;
  document.getElementById("description").innerHTML =
    `${recipes[randamIndex].description}`;
}
...
function dispalyIngredients(ingredients) {
  var ele = document.getElementById("ingredients-list");
  ele.innerHTML = "";
  for (var i = 0; i < ingredients.length; i++) {
    var item = document.createElement("li");
    ((item.className = "d-flex align-items-start mb-4"),
      (item.innerHTML = `
...
function dispalyInstructions(instructions) {
  var ele = document.getElementById("instructions-list");
  ele.innerHTML = "";
...
function dispalyNutrition(nutrition) {
  document.getElementById("calories-value").innerHTML = nutrition.calories;
  document.getElementById("protein-value").innerHTML = nutrition.protein;
  document.getElementById("carbs-value").innerHTML = nutrition.carbs;
  document.getElementById("fat-value").innerHTML = nutrition.fat;
  document.getElementById("fiber-value").innerHTML = nutrition.fiber;
  document.getElementById("sodium-value").innerHTML = nutrition.sodium;
}

function dispalyTips(tips) {
  var ele = document.getElementById("tips-list");
  ele.innerHTML = "";
